...
import com.lagradost.cloudstream3.tv.presentation.common.ImmersiveListMoviesRow
import com.lagradost.cloudstream3.tv.presentation.common.ItemDirection
import com.lagradost.cloudstream3.tv.presentation.common.PosterImage
...
fun Top10MoviesList(
    ...
    var selectedMovie by remember(movieList) { mutableStateOf(movieList.firstOrNull()) }
